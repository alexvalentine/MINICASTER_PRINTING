...
#    g.toggle_pressure(pressure_box)
#    g.dwell(dwell)
#    g.meander(x=5,y=5,spacing=0.2,start='UR',orientation='x')
#    g.move(x=-2.5)
#    g.move(y=5)
#    g.move(x=0.5)
#    g.move(x=-0.5,y=0.5)
...
#    g.move(x=0.5)
#    g.move(x=-2.5)
#    g.meander(x=5,y=5,spacing=0.2,start='LL',orientation='x')
#    g.toggle_pressure(pressure_box)
#    g.feed(10)
#    g.clip(axis=nozzle, height=3, direction='-y')
#    
...
agtpu_single_filaments_layered(nozzle='z',height=0.12,speed=5,dwell=0.2,pressure=35)
